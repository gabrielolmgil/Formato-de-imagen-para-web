    ...
    const applyFilter = (filter: string, value?: number) => {
        ...
        img.onload = () => {
            ...
            for (let i = 0; i < data.length; i += 4) {
                ...
                } else if (filter === "brightness" && value !== undefined) {
                    data[i] = data[i] + value;
    ...
    return (
        <div className="text-center p-4">
            ...
            <div>
                ...
                <button onClick={() => applyFilter("brightness", 50)} className="bg-yellow-500 text-white px-4 py-2 m-2 rounded">
                    Aumentar Brillo
                </button>
                <button onClick={() => applyFilter("brightness", -50)} className="bg-gray-500 text-white px-4 py-2 m-2 rounded">
                    Disminuir Brillo
                </button>
            </div>
